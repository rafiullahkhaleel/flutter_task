  ...
  void filteredData(){
    setState(() {
      filteredList = dataList.where((data){
        return data.title!.toLowerCase().contains(searchController.text.toLowerCase());
      }).toList();
    });
  }
                      ...
                      onTap: (){
                        Navigator.push(context,
                            MaterialPageRoute(builder: (context)=>ProductsDetailScreen(
                                image: filteredList[index].images![0].toString(),
                                name: filteredList[index].title.toString(),
                                price: filteredList[index].price!,
                                category: filteredList[index].category.toString(),
                                brand: filteredList[index].brand.toString(),
                                rating: filteredList[index].rating!,
                                stock: filteredList[index].stock!,
                                description: filteredList[index].description.toString()
                            )));
                      },
                      child: Card(
                        elevation: 0.5,
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              CachedNetworkImage(
                                imageUrl: filteredList[index].images?[0] ?? '',
                                height: height * .25,
                                width: width * .8,
                                placeholder:
